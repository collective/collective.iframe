# -*- coding: utf-8 -*-
"""Installer for the collective.iframe package."""
...
setup(
    ...
    url="https://github.com/collective/collective.iframe",
    project_urls={
    ...
    target = plone
    [console_scripts]
    update_locale = collective.iframe.locales.update:update_locale
    """,
)
